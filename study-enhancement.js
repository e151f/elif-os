...
window.addEventListener('click',e=>{const b=e.target.closest?.('[data-page="study"]');if(b)setTimeout(render,0)},true);
window.addEventListener('click',click,true);
window.ELIFStudyEnhancement={render};
